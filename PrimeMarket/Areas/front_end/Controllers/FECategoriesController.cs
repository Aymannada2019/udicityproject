...
namespace PrimeMarket.Areas.front_end.Controllers
{
    public class FECategoriesController : Controller
    {
        ...
        // GET: front_end/FECategories
        public ActionResult Index()
        {
            return View(db.Categories.ToList());
        }

        // GET: front_end/FECategories/Details/5
        ...
        // GET: front_end/FECategories/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: front_end/FECategories/Create
        ...
        // GET: front_end/FECategories/Edit/5
        ...
        // POST: front_end/FECategories/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: front_end/FECategories/Delete/5
        ...
        // POST: front_end/FECategories/Delete/5
