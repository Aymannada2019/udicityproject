<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamCam_Sim.aspx.cs" Inherits="Cpanel.Exams.ExamCam_Sim" %>
...
<script type="text/javascript">
    var pageUrl = '<%=ResolveUrl("ExamCam_Sim.aspx") %>';
...
<br />
    <asp:Label runat="server" ID="lbl_log"></asp:Label>
