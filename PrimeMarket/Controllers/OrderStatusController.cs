...
namespace PrimeMarket.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderStatusId,OrderStatus")] OrderStatu orderStatu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderStatusId,OrderStatus")] OrderStatu orderStatu)
        {
            if (ModelState.IsValid)
            {
