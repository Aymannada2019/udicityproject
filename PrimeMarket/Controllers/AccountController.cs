...
namespace PrimeMarket.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)//, ILogger Plogger)
        {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var callbackUrl = Url.Action("ResetPassword", "Account", new { email = model.Email, code = code }, protocol: Request.Url.Scheme);
        ...
        private void SendEmail(string recipientMail, string emailBody, string mailSubject)
        {
            ...
            MailMessage mailMessage = new MailMessage(MailSender, recipientMail);
